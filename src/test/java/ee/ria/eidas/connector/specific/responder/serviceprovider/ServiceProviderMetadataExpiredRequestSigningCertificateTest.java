...
public class ServiceProviderMetadataExpiredRequestSigningCertificateTest extends ServiceProviderTest {

    @BeforeAll
    static void beforeAll() {
        startServiceProviderMetadataServer();
        startServiceProvider1MetadataServer("sp1-expired-request-signing-cert.xml");
    }
