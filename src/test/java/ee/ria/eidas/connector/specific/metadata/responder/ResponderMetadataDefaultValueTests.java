...
public class ResponderMetadataDefaultValueTests extends SpecificConnectorTest {
    ...
    @Test
    void defaultDigestMethodsAreSet() {
    ...
    @Test
    void defaultSigningMethodsAreSet() {
    ...
    @Test
    void defaultSupportedBindingsAreSet() {
    ...
    @Test
    void defaultSupportedAttributesAreSet() {
    ...
    @Test
    void defaultWantAuthnRequestsSignedIsTrue() {
    ...
    @Test
    void defaultProtocolSupportEnumeration() {
    ...
    @Test
    void defaultNameIdFormatNotSet() {
