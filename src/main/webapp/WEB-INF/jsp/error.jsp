    ...
    <div class="c-layout--full">
            ...
            <div class="container">
                <h1 class="c-header__logo">
                    <a class="c-header__logo-link" href="#">
                        <img id="eeidp-logo-et" src="resources/assets/eeidp-logo-et.png" alt="eeidp">
        ...
        <div class="container">
            <div class="alert alert-error" role="alert">
                ...
                <p id="incidentNumber"><strong>Eidas Connector service incident number: <c:out value="${incidentNumber}"/></strong></p>
            </div>
        </div>
    </div>
    <div class="c-footer">
                ...
                <div class="c-footer__col">
                    <div class="c-footer__block">
                        <div class="c-footer__block-logo">
                            <img id="cef-logo-en" src="resources/assets/cef-logo-en.svg" alt="cef">
                        </div>
                    </div>
                </div>
            </div>
