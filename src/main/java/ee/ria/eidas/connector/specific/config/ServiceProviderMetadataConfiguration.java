...
public class ServiceProviderMetadataConfiguration {
    ...
    @Bean
    public ServiceProviderMetadataResolver serviceProviders(SpecificConnectorProperties connectorProperties,
                                                            KeyStore metadataTrustStore,
                                                            ParserPool parserPool,
                                                            HealthContributorRegistry healthContributorRegistry) throws ResolverException,
            ComponentInitializationException, CertificateException, KeyStoreException {
        ...
        if (connectorProperties.getServiceProviders() != null) {
            for (ServiceProvider serviceProvider : connectorProperties.getServiceProviders()) {
                ...
                ExplicitKeySignatureTrustEngine signatureTrustEngine = getSignatureTrustEngine(metadataTrustStore, keyAlias);
    ...
    public ExplicitKeySignatureTrustEngine getSignatureTrustEngine(KeyStore keyStore, String keyAlias) throws KeyStoreException {
