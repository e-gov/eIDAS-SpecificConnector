...
| `eidas.connector.responder-metadata.signature-algorithm` | No | Signature algorithm used to sign published metadata (defined by RFC 4051). Default value: http://www.w3.org/2001/04/xmldsig-more#rsa-sha512 |
